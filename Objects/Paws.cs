...
namespace IIS.fdsss111
{
    ...
    public class Paws : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.fdsss111.Cat.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Cat"})]
        public virtual IIS.fdsss111.Cat Cat
        {
            get
            {
                ...
                IIS.fdsss111.Cat result = this.fCat;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View PawsE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("PawsE", typeof(IIS.fdsss111.Paws));
                }
            }
        }
    }
    ...
    public class DetailArrayOfPaws : ICSSoft.STORMNET.DetailArray
    {
        ...
        //  *** Start programmer edit section *** (IIS.fdsss111.DetailArrayOfPaws members)

        //  *** End programmer edit section *** (IIS.fdsss111.DetailArrayOfPaws members)
        ...
        /// </summary>
        public DetailArrayOfPaws(IIS.fdsss111.Cat fCat) : 
                base(typeof(Paws), ((ICSSoft.STORMNET.DataObject)(fCat)))
        {
        }
        
        public IIS.fdsss111.Paws this[int index]
        {
            get
            {
                return ((IIS.fdsss111.Paws)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.fdsss111.Paws dataobject)
        {
